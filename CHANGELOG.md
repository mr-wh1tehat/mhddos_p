...
- **03.04.2022** Fixed 'Too many open files' bug
...
- **29.03.2022** Added support for the local configuration file 
- **28.03.2022** Table output implemented `--table` 
- **27.03.2022**
    - Implemented DBG, BOMB, and KILLER methods to synchronize with the original MHDDoS
- **26.03.2022**
